...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import assimp_win_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("fe2041e4-48f9-56de-9ac5-7523ba92ef05"))
platforms = [Pkg.Artifacts.unpack_platform(e, "assimp_win", artifacts_toml) for e in artifacts["assimp_win"]]
...
if best_platform === nothing
    @debug("Unable to load assimp_win; unsupported platform $(triplet(platform_key_abi()))")
else
